...
import { 
  ...
  Hash, BrainCircuit, Rocket, Grid, MousePointerClick, MoveHorizontal, Target as TargetIcon, Users
} from 'lucide-react'; 
...
const games = [
  ...
  },
  {
    id: 'tic-tac-toe',
    title: 'Tic Tac Toe',
    description: "Classic X's and O's. Play against a friend or the (basic) computer.",
