...
const puzzles: PuzzleItem[] = [
  ...
  { id: 'logic_005', name: 'River Crossing Puzzle', level_hint: "Intermediate", category: 'Logic Puzzles', description: 'Get the farmer, wolf, goat, and cabbage across the river safely.', locked: true, unlock_cost_coins: 60, unlock_by_password_possible: true },
  ...
  { id: 'conceptual_chem_002', name: 'Ideal Gas Law Scenario', level_hint: "Expert", category: 'Conceptual Puzzles (NEET Focus)', description: 'Explain how changing pressure affects volume and temperature for an ideal gas, given certain conditions.', locked: true, unlock_cost_coins: 70, unlock_by_password_possible: true },
