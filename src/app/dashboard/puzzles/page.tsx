...
import { Puzzle, Brain, Calculator, Palette, ChevronRight, Lock, Coins, KeyRound, Eye, MessageSquare } from 'lucide-react';
...
const puzzles: PuzzleItem[] = [
  ...
  { id: 'logic_003', name: 'Einstein\'s Riddle (Zebra Puzzle)', category: 'Logic Puzzles', description: 'A classic logic grid puzzle attributed to Einstein. Who owns the zebra?', locked: true, unlock_cost_coins: 100, unlock_by_password_possible: true },
  ...
  { id: 'math_003', name: 'The Tower of Hanoi', category: 'Mathematical Challenges', description: 'Move the stack of disks to another peg with minimal moves.', locked: false },
  // Creative Conundrums
  ...
  { id: 'creative_003', name: 'Rebus Rally', category: 'Creative Conundrums', description: 'Decipher picture-based word puzzles.', locked: false},
  // Conceptual Puzzles (NEET-related)
  { id: 'conceptual_phy_001', name: 'Vector Voyage', category: 'Conceptual Puzzles (NEET Focus)', description: 'A ship sails 3km East, then 4km North. What is its displacement? (Solve conceptually)', locked: false },
  { id: 'conceptual_chem_001', name: 'Balancing Act', category: 'Conceptual Puzzles (NEET Focus)', description: 'Conceptually balance the chemical equation: CH4 + O2 -> CO2 + H2O.', locked: true, unlock_cost_coins: 40, unlock_by_password_possible: true },
  { id: 'conceptual_bio_001', name: 'Genetic Code Cracker', category: 'Conceptual Puzzles (NEET Focus)', description: 'Given a DNA sequence, determine the mRNA and corresponding amino acid sequence using a conceptual codon chart.', locked: false},
  // Visual Puzzles
  { id: 'visual_001', name: 'Spot the Difference', category: 'Visual Puzzles', description: 'Find all the differences between two seemingly identical images.', locked: false },
  { id: 'visual_002', name: 'Optical Illusion Analysis', category: 'Visual Puzzles', description: 'Explain the principles behind a famous optical illusion.', locked: true, unlock_cost_coins: 60 },
  // Word Puzzles
  { id: 'word_001', name: 'Anagram Hunt', category: 'Word Puzzles', description: 'Unscramble these NEET-related terms: HPOYSCIT, GEBYOOLI, HRTYSMICE.', locked: false },
  { id: 'word_002', name: 'Crossword Challenge (Science)', category: 'Word Puzzles', description: 'Complete a mini-crossword with scientific clues.', locked: true, unlock_cost_coins: 45, unlock_by_password_possible: true },
];
